...
TEST(E2E_Phase3, ComponentLeadCoordinatesMultipleModules) {
  ...
  auto msg_to_component = KeystoneMessage::create(chief->getAgentId(),
  ...
  auto msg_from_mod1 = KeystoneMessage::create(module_lead_1->getAgentId(),
                                               component_lead->getAgentId(),
                                               "module_result",
                                               module_1_result);
  module_lead_1->sendMessage(msg_from_mod1);

  auto msg_from_mod2 = KeystoneMessage::create(module_lead_2->getAgentId(),
                                               component_lead->getAgentId(),
                                               "module_result",
                                               module_2_result);
  ...
  auto final_msg = KeystoneMessage::create(component_lead->getAgentId(),
                                           chief->getAgentId(),
                                           "component_result",
                                           component_result);
