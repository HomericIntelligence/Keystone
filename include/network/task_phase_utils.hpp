...
/// @return String representation of the phase (e.g., "PENDING", "EXECUTING", "COMPLETED")
...
/// @param phase_str String representation (e.g., "PENDING", "EXECUTING", "COMPLETED")
/// @return Task phase enum value, or TASK_PHASE_UNSPECIFIED if string is unrecognized
