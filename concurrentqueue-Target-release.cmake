...
conan_package_library_targets("${concurrentqueue_LIBS_RELEASE}"    # libraries
                              ...
                              "${concurrentqueue_BIN_DIRS_RELEASE}" # package_bindir
                              "${concurrentqueue_LIBRARY_TYPE_RELEASE}"
                              "${concurrentqueue_IS_HOST_WINDOWS_RELEASE}"
                              concurrentqueue_DEPS_TARGET
                              concurrentqueue_LIBRARIES_TARGETS  # out_libraries_targets
                              "_RELEASE"
                              "concurrentqueue"    # package_name
                              "${concurrentqueue_NO_SONAME_MODE_RELEASE}")  # soname
...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET concurrentqueue::concurrentqueue
                 ...
                 $<$<CONFIG:Release>:${concurrentqueue_LINKER_FLAGS_RELEASE}>)
    set_property(TARGET concurrentqueue::concurrentqueue
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${concurrentqueue_INCLUDE_DIRS_RELEASE}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET concurrentqueue::concurrentqueue
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${concurrentqueue_LIB_DIRS_RELEASE}>)
    set_property(TARGET concurrentqueue::concurrentqueue
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${concurrentqueue_COMPILE_DEFINITIONS_RELEASE}>)
    set_property(TARGET concurrentqueue::concurrentqueue
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${concurrentqueue_COMPILE_OPTIONS_RELEASE}>)
